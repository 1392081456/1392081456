...
- The detection content (30 Sigma rules, 24 Suricata signatures) is also packaged for direct production use in a separate CI-linted repository: [**`sigma-detection-rules`**](https://github.com/1392081456/sigma-detection-rules) — MIT-licensed, with a deterministic extractor that regenerates every rule from the underlying `ctf-notes/labs` writeups. Methodology behind the four-step CVE → rule pipeline is documented on my [blog](https://1392081456.github.io/2026/05/26/cve-to-sigma-30min/).
